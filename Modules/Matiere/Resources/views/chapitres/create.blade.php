...
<div class="tab-pane bg-white" id="create">
    ...
    <form action="/chapitre/store" method="post" enctype="multipart/form-data" role="form">
        @csrf
        <div class="row">
            ...
            <div class="form-group col-md-4">
                ...
                <hr>
                <div>
                    <input type="text" name="competences" value="{{old('competences')}}" placeholder="competences" class="form-control">
                </div>
            </div>
            ...
            <div class="form-group col-md-3">
                ...
                <hr>
                <input type="text" name="prerequis" value="{{old('prerequis')}}" placeholder="prerequis" class="form-control"/>
            </div>
