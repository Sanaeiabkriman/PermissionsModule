...
<div class="row">
    ...
    <div class="form-group col-md-4">
        ...
        <hr>
        <div>
            <input type="text" name="competences" value="{{old('competences',$chapitre->competences)}}"
    ...
    <div class="form-group col-md-3">
        ...
        <hr>
        <textarea type="text" cols="30" rows="10" name="description" value="{{old('description')}}"
            placeholder="description" class="form-control">{{$chapitre->description}}</textarea>
    </div>
    <div class="form-group col-md-3">
        <h5 class="bg-light m-1 p-1">Entrer les prerequis</h5>
        <hr>
        <input type="text" name="prerequis" value="{{old('prerequis',$chapitre->prerequis)}}" placeholder="prerequis"
            class="form-control" />
    </div>
