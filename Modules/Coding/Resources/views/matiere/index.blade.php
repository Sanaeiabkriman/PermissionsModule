...
<div class="tab-pane bg-white" id="create">
    <h4 class="p-2 bg-navy text-center rounded border-primary">Création d'un matiere</h4>
<form action="/matiere/create" method="post" enctype="multipart/form-data" role="form">
    @csrf
    <div class="row">
        ...
        <table class="table table-condensed">
            <tbody>
                ...
                <tr class="row m-auto">
                    ...
                    <td class="col-1">
                        <a href="/matiere/edit/{{$item->id}}" type="submit" class="btn btn-light">Editer</a>
                    </td>      
                    <td class="col-1">
                        <form action="/matiere/delete/{{$item->id}}" method="POST">
                            @csrf
