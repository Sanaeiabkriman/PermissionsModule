...
<form action="/categorie/create" method="post" enctype="multipart/form-data" role="form">
    @csrf
    <div class="box p-2">
        ...
        <table class="table table-condensed">
            <tbody>
                ...
                <tr class="row m-auto">
                    ...
                    <td class="col-1">
                        <a href="/categorie/edit/{{$item->id}}" type="submit" class="btn btn-light">Editer</a>
                    </td>          
                    <td class="col-1">
                        <form action="/categorie/delete/{{$item->id}}" method="POST">
                            @csrf
